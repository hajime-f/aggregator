...
if __name__ == "__main__":
    ...
    (2) 抽出したコンテンツを横断的に分析し、類似のコンテンツを統合した上で、日本語で要約する。ただし、統合・要約した元のコンテンツが特定できるように、タイトルとURLを対応づけておく。
    (3) 30個以下のトピックに対して上記日本語の要約を準備する。ただし、これらのトピックは互いに重複がないようにすること。また、各トピックの要約は、500〜700文字程度とすること。
